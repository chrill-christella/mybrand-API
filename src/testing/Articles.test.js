...
describe("create a blog", () => {
  it("should create a new blog post with all fields filled", (done) => {
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpIjoiYWRAZ21haWwuY29tIiwiaWQiOiI2M2QxMzUyMDRlMDU4Yzg5NGQ1Y2YzMmMiLCJpYXQiOjE2NzQ2NjczMTh9.5bYP266iJ0p4z7RD0CFOY2n5T28qNqBy27q4BZoZ8Xo";
    chai
      .request(app)
      .post("/api/article")
      .set("token", `${token}`)
